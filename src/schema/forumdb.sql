...
CREATE DATABASE forumdb DEFAULT CHARACTER SET utf8;
USE forumdb;
...
INSERT INTO `t_user` VALUES (1,'admin','1234',1,0,205);
...
CREATE TABLE `t_board` (
  ...
  `board_name` varchar(15) NOT NULL default '' COMMENT '论坛版块名',
  `board_desc` varchar(25) default NULL COMMENT '论坛版块描述',
  `topic_num` int(11) NOT NULL default '0' COMMENT '帖子数目',
  PRIMARY KEY  (`board_id`),
  KEY `AK_Board_NAME` (`board_name`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

INSERT INTO `t_board` VALUES (1,'健康','共同健康生活',0);
INSERT INTO `t_board` VALUES (2,'学习','分享学习方法',0);
